...
<head>
    ...
    <style>
        ...
        h1 { margin-top:0; margin-bottom:18px; font-size:1.25rem; color:var(--text); }
...
<h1>Add_Instructor</h1>
    <form:form modelAttribute="instructor" method="post" action="instructor/save">
        <label>Name:</label>
